...
command : *.sticker nobg* or *.stiker nobg*
...
usage : *.url2img [tipe] [url]*

command : *.simi*
desc : sua mensagem será respondida por simi
usage : *.simi yourmessage*
...
usage : just send the commandnote : can only be used when the bot becomes admin, and the one who sends the command is admin!
...
usage : *.simih 1* to activate simi mode and *.simih 0* para desativar o modo simi
